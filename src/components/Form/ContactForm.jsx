    ...
    <section className="bg-[#0067B1] text-white px-[15%] py-[10%]">
      <div className="max-w-[1362px] grid lg:grid-cols-2 lg:gap-5 gap-10">
        <div className="order-2 lg:order-1">
          ...
          <hr className="hidden lg:block h-[2px] w-12 bg-white my-3 md:my-5 lg:my-6 2xl:my-8" />
        ...
        >
          ...
          <hr className="lg:hidden block h-[2px] w-12 bg-white my-3 md:my-5 lg:my-6 2xl:my-8" />
